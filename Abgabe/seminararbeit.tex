...
Um die Funktionsweise unserer Implementierung zu verdeutlichen sieht man in Abbildung \ref{fig:packing} wir hier eine Serie von Bildern ausgewählter Iterationen einer Ausführung des Algorithmus. Die Bilder wurden mit der Funktion die Animationen als GIF zu exportieren erstellt, stellen also eine tatsächliche ausführung in der Abgabeversion des Softwareprojekts dar.
